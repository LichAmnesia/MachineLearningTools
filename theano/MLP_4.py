...
# @Date:   2016-04-14 22:02:07
# @Last Modified time: 2016-04-19 21:06:15
# @FileName: MLP_4.py
...
#规则化项：常见的L1、L2_sqr
        ...
        self.L2_sqr = (
            (self.hiddenLayer.W ** 2).sum() + abs(self.hiddenLayer2.W ** 2).sum()
...
#updates[(),(),()....],每个括号里面都是(param, param - learning_rate * gparam)，即每个参数以及它的更新公式
    ...
    print("classifier.params = ", classifier.params)
